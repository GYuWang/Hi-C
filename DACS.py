...
def TAD_calculator(command='TAD_calculator'):
    ...
    if (len(sys.argv) < 3) and ('-h' not in sys.argv) and ('--help' not in sys.argv):
        ...
        print("\nusage:\npython DACS.py TAD_calculator <contact_map_file_paths> [optional arguments]\n\n"
              "for more help, please try: python DACS.py TAD_calculator -h\n")

        return 0

    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                     usage="\n\nusage:\npython DACS.py TAD_calculator <contact_map_file_paths> "
                                           "[optional arguments]\n\n", description='')
    parser.add_argument('command', default=None,
                        help="set as 'TAD_calculator' to identify TAD relative to Hi-C contact map")

    parser.add_argument('--contact_map', dest="contact_map", default=None,
                        help="path to Hi-C contact map")

    parser.add_argument('--up_limit', dest="up", default=None,
                        help="up limit for Hi-C contact map")

    parser.add_argument('--down_limit', dest="down", default=0,
                        help="down limit for Hi-C contact map")

    parser.add_argument('--TAD_output', dest="TAD_output", default=None,
    ...
    np.savetxt(args.TAD_output, TAD, delimiter="\t")
...
# input1 = '/Users/guangyu/Work/Hi-C/Data/Contactmatrix/HUVEC/' + chr + '_matrix_HUVEC_Coverage.txt'
# input2 = '/Users/guangyu/Work/Hi-C/Data/Contactmatrix/IRM90/matrix/' + chr + '_matrix_IMR90_Coverage.txt'
#
# map1 = np.loadtxt(input1)
# map2 = np.loadtxt(input2)
#
# s1 = map1.sum()
# s2 = map2.sum()
#
...
# up = '11000'
#
# input1 = '/Users/guangyu/Work/Hi-C/Data/Contactmatrix/HUVEC/new_file/' + chr + '_matrix_HUVEC_Coverage.txt.' + \
#          down + '.' + up + '.new'
# input2 = '/Users/guangyu/Work/Hi-C/Data/Contactmatrix/IRM90/matrix/new_file/' + chr + '_matrix_IMR90_Coverage.txt.' + \
#          down + '.' + up + '.new'
#
#
#
# bound1 = np.array(TAD_calling(input1, 9, 1, 25, 1))
# bound2 = np.array(TAD_calling(input2, 25, 1, 25, 1))
#
#
# np.savetxt('/Users/guangyu/Work/Hi-C/Data/Contactmatrix/differential/pipline/output/test.HUVEC.txt',
#            bound1, delimiter="\t")
# np.savetxt('/Users/guangyu/Work/Hi-C/Data/Contactmatrix/differential/pipline/output/test.IMR90.txt',
#            bound2, delimiter="\t")
